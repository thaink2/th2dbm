...
The package serves as a ususer interface to work with Relational Database, by do the following actions :

-   Visualize your data
-   Add tables
-   Add variables : differents type(numerical, ctageorical, logical, UUIDs)
-   Add entries 
-   
...
# Demo 
![Démo de Database Manager](https://github.com/thaink2/th2dbm/blob/main/inst/video/demo_DBM.mp4){width="1080" height="512"}
