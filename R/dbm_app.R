        ...
        bs4Dash::dashboardPage(
            ...
            bs4Dash::dashboardSidebar(
                bs4Dash::sidebarMenu(
                    ...
                    uiOutput("dynamic_menu_items")  # Utilisation d'un menu dynamique
                )
            ),
...
dbm_server <- function(input, output, session){
    ...
    # Mise à jour du menu latéral en fonction de la connexion à la base de données
    ...
    createTableServer("create_table", con = db_config$con, schema = db_config$schema, data_changed = data_changed, parent_session = session)
